...
/**
 * Built-in Chapter Page: Sceau user docs — AI Optimization.
 */
final class SceauDocumentationAiOptimizationPage extends GrimoireChapterPage
{
    public static string $tomeId = 'sceau';

    public static string $chapterSlug = 'ai-optimization';
