...
/**
 * Built-in Chapter Page: Sceau user docs — SEO Settings.
 */
final class SceauDocumentationSeoSettingsPage extends GrimoireChapterPage
{
    public static string $tomeId = 'sceau';

    public static string $chapterSlug = 'seo-settings';
